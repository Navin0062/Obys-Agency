const locoScrolling = () => {
  ...
  //   const menuOpener = document.querySelector('.menu-opener__square');
  //   const hero = document.querySelector('.hero');
  //   const navMenu = document.querySelector('.nav-menu');
  //   const navLeftLa = document.querySelector('.nav-left-la');
  //   // const navLeftRa = document.querySelector('.nav-left-ra');
  ...
  //       navLeftLa.style.position = 'fixed';
  //       // navLeftRa.style.position = 'fixed';
  //       isMenuOpen = true;
  //     } else {
  //       hero.style.display = 'block';
  //       navMenu.style.display = 'none';
  //       navLeftLa.style.position = 'absolute';
  //       // navLeftRa.style.position = 'absolute';
  //       isMenuOpen = false;
  //     }
  //   })
  // });
  ...
  const containerFour = document.getElementById('container-four');
  const containerFive = document.getElementById('container-five');
  ...
  navLeftRa.style.top = navLeftLa.offsetHeight + 'px';
